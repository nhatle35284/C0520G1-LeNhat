package nhat.coder.casestudyspring.common.day;
...
public class Birthday18ConstraintValidation implements ConstraintValidator<ValidateBirthday18,String> {
    ...
    @Override
    public void initialize(ValidateBirthday18 constraintAnnotation) {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        if ( year - Integer.parseInt(array[2]) < 18 || year - Integer.parseInt(array[2]) > 110 ) {
            context.disableDefaultConstraintViolation();
